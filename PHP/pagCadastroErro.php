...
<html lang="en">
<head>
	<title>StoreModel | Cadastro</title>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
<!--===============================================================================================-->	
<link rel="icon" type="image/png" href="../templat/images/icons/favicon.ico"/>
<!--===============================================================================================-->
		...
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form class="login100-form validate-form">
				<span class="login100-form-title p-b-37">
					Pedimos desculpas, mas NÃO foi possível cadastrar o usuário  com sucesso!!!
				</span>
                          				
                            </br>                                <p style="text-align: center;">Verifique se todos os dados estão corretos ou preenchidos</p>

				</br>
                               	<div class="container-login100-form-btn">
                                    <a href="../template/index.html"<button class="login100-form-btn" style="text-align: center">
						continue navegando na Store Model.
                                        </button></a>
				</div>
