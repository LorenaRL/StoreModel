...
<link href="../../template/css/team.css" rel="stylesheet" type="text/css" media="all" />
		...
		<ul>
		 <li><i class="fa fa-mobile" aria-hidden="true"></i> Celular :61 995643211</li>
			...
			<li><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="mailto:info@example.com">storemodeloficial@gmail.com</a></li>
                        <li> <a href="../logout.php" data-toggle="modal" data-target="#myModal"><i class="fa fa-sign-out" aria-hidden="true"></i> Sair </a></li></ul>
	</div>
</div>
<!-- //header -->
<!-- header-bot -->
					...
					<div class="modal-header">
						...
						<h3 class="agileinfo_sign">Cadastre-se <span>Agora</span></h3>
						  ...
						  <ul class="social-nav model-3d-0 footer-social w3_agile_social top_agile_third">
														...
														<div class="clearfix"></div>
														<p><a href="#">Para se registrar é preciso concordar com os nossos temos.</a></p>
			...
			<div class="agile_ab_w3ls_info">
				<div class="col-md-6 ab_pic_w3ls">
				 ...
				 <div class="col-md-6 ab_pic_w3ls_text_info">
				    <h5>Sobre  a Store<span>Model</span> </h5>
					<p>A STOREMODEL é uma loja que gera estilos diversificados e sofisticados.</p>
					<p>Temos o prazer de dizer que possuimos todos os estilos e sempre trazemos novidades ao nosso público.</p>
					<p> As roupas são desenhadas por estilistas renomados, e costuradas com os tecidos mais cobiçados 
						pelo o mundo da moda.</p>
						<h3 style="text-align: center">StoreModel <br/> </h3><h4 style="text-align: center">Há mais de 10 anos
					vestindo quem tem bom gosto.</h4>
				</div>
				  <div class="clearfix"></div>
			</div>    
            <div class="banner_bottom_agile_info_inner_w3ls">
    	           <div class="col-md-6 wthree_banner_bottom_grid_three_left1 grid">
						<figure class="effect-roxy">
							<img src="images/bottom1.jpg" altimage=" " class="img-responsive" />
							<figcaption>
	...
	<!-- /we-offer -->
		<div class="sale-w3ls">
			<div class="container">
				...
				<a class="hvr-outline-out button2" href="singleUsuario.html">Compre Agora </a>
			</div>
		</div>
	<!-- //we-offer -->
<!--/grids-->
...
<!-- js -->
<script type="text/template/javascript" src="../js/jquery-2.1.4.min.js"></script>
<!-- //js -->	
	<!-- cart-js -->
