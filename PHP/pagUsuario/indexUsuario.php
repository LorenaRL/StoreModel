				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h3 class="agileinfo_sign">Logar <span>Agora</span></h3>
                                                ...
                                                <form action="../php/conexaoLogin.php" method="POST">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h3 class="agileinfo_sign">Cadastra-se <span>Agora</span></h3>
                                                ...
                                                <form action="../php/cadastraUsuario.php" method="post">
							<div class="styled-input agile-styled-input-top">
							...
							<div class="styled-input">
								<input type="password" name="senhaRepete" required=""> 
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active"> 
				<div class="container">
					<div class="carousel-caption">
						...
						<p>Todo dia é queima de estoque</p>
						<a class="hvr-outline-out button2" href="mensUsuario.php">Compre Agora</a>
					</div>
				</div>
			</div>
			<div class="item item2"> 
				<div class="container">
					<div class="carousel-caption">
						<h3>Coleção<span>Verão </span></h3>
						<p>Novos produtos á Venda</p>
						<a class="hvr-outline-out button2" href="mensUsuario.php">Compre Agora </a>
					</div>
				</div>
			</div>
			<div class="item item3"> 
				<div class="container">
					<div class="carousel-caption">
						<h3>HotFoot <span>Sale</span></h3>
						<p>A loja com a sapataria mais diversificada</p>
                                                <a class="hvr-outline-out button2" href="mensUsuario.php">Compre Agora </a>
					</div>
				</div>
			</div>
			<div class="item item4"> 
				<div class="container">
					<div class="carousel-caption">
						<h3>Coleção <span>Inverno</span></h3>
						<p>Novos produtos</p>
						<a class="hvr-outline-out button2" href="mensUsuario.php">Shop Now </a>
					</div>
				</div>
			</div>
			<div class="item item5"> 
				<div class="container">
					<div class="carousel-caption">
						<h3>Acessórios <span>Sale</span></h3>
						<p>Os mais modernos acessórios</p>
						<a class="hvr-outline-out button2" href="mensUsuario.php">Compre Agora </a>
					</div>
				</div>
			</div> 
	...
	<div class="schedule-bottom">
		...
		<div class="col-md-6 agileits_schedule_bottom_right">
			<div class="w3ls_schedule_bottom_right_grid">
				<h3>Economize até <span>50%</span> esta semana</h3>
				<p>Renove o seu guarda ropa com as melhores marcas e modelos por um precinho "camarada"!!!</p>
...
<!-- //schedule-bottom -->
  <!-- banner-bootom-w3-agileits -->
	...
	<div class="container">
		<h3 class="wthree_text_info">Quais são as  novas<span> Tendências?</span></h3>
	
		<div class="col-md-5 bb-grids bb-left-agileits-w3layouts">
			<a href="womensUsuario.php">
...
<!--/grids-->
      <div class="agile_last_double_sectionw3ls">
            <div class="col-md-6 multi-gd-img multi-gd-text ">
                <a href="womensUsuario.php"><img src="images/bot_1.jpg" alt=" "><h4>Ofertas com <span>50%</span> de desconto</h4></a>
					
			</div>
			 <div class="col-md-6 multi-gd-img multi-gd-text ">
                             <a href="womensUsuario.php"><img src="images/bot_2.jpg" alt=" "><h4>Ofertas com <span>50%</span> de desconto</h4></a>
			</div>
			<div class="clearfix"></div>
	   </div>							
<!--/grids-->
<!-- /new_arrivals --> 
						...
						<div class="tab1">
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
										...
										<img src="images/m1.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Vizualizar</a>
												</div>
											</div>
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Saia Formal Blue </a></h4>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										...
										<img src="images/m2.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Visualizar</a>
												</div>
											</div>
											<span class="product-new-top">Novo</span>
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Suéter Manga Longa Gabi Full</a></h4>
										<div class="info-product-price">
											<span class="item_price">R$45.99</span>
											<del>R$69.71</del>
										</div>
                            ...
                            <div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Calça Track Azul Escuro </a></h4>
										<div class="info-product-price">
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Camiseta Entorno do Pescoço Preta</a></h4>
										<div class="info-product-price">
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Calça Jeans Preta Masculina</a></h4>
										<div class="info-product-price">
								...
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Cinto Reversible </a></h4>
										<div class="info-product-price">
								...
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Blazer Party Masculino </a></h4>
										<div class="info-product-price">
						...
						<div class="tab2">
							 <div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html"> Saia  A-line Black</a></h4>
										<div class="info-product-price">
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Blusa Top Azul </a></h4>
										<div class="info-product-price">
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Calja Jeans Skinny </a></h4>
										<div class="info-product-price">
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Short Básico Preto</a></h4>
										<div class="info-product-price">
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Calça Track Rosa</a></h4>
										<div class="info-product-price">
						    ...
						    <div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Meia Cano Longo Ankle </a></h4>
										<div class="info-product-price">
								...
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Leg Feminina Reebok Tights</a></h4>
										<div class="info-product-price">
											<span class="item_price">R$130.99</span>
											<del>R$169.71</del>
										</div>
					 ...
					 <!--//tab_two-->
						...
						<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Bolsa para Laptop da Messenger </a></h4>
										<div class="info-product-price">
											<span class="item_price">R$140.99</span>
											<del>R$169.71</del>
										</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Mochila da Puma </a></h4>
										<div class="info-product-price">
                            ...
                            <div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html"> Mochila para Laptop</a></h4>
										<div class="info-product-price">
											<span class="item_price">R$120.99</span>
											<del>R$189.71</del>
										</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Bolsa de Viagem Duffel  </a></h4>
										<div class="info-product-price">
											<span class="item_price">R$190.99</span>
											<del>R$259.71</del>
										</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Bolsa Hand-held  </a></h4>
										<div class="info-product-price">
											<span class="item_price">R$190.99</span>
											<del>R$259.71</del>
										</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Bolsa Butterflies</a></h4>
										<div class="info-product-price">
											<span class="item_price">R$190.99</span>
											<del>R$259.71</del>
										</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Bolsa Costa Swiss  </a></h4>
										<div class="info-product-price">
								...
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Bolsa Noble Designs  </a></h4>
										<div class="info-product-price">
											<span class="item_price">R$120.99</span>
											<del>R$159.71</del>
										</div>
						...
						<div class="tab4">
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Sparx Sporty Canvas Tênis</a></h4>
										<div class="info-product-price">
											<span class="item_price">R$160.99</span>
											<del>R$199.71</del>
										</div>
	...
	<!-- /we-offer -->
		<div class="sale-w3ls">
			<div class="container">
				<h6>Nós oferecemos <span>40%</span> de Desconto</h6>
 
				<a class="hvr-outline-out button2" href="single.html">Compre Agora </a>
			</div>
		</div>
	<!-- //we-offer -->
<!--/grids-->
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
							<div class="login-grids">
									...
									<div class="login-right">
										...
										<form >
											...
											<div class="single-bottom">
												...
												<label for="brand"><span></span>Lembre-me.</label>
											</div>
											<div class="sign-in">
								...
								<p>Para logar você concorda com o nossos <a href="#">Termos e Condições</a> e <a href="#">Politica de Privacidade</a></p>
							</div>
						</div>
					</div>
				</div>
