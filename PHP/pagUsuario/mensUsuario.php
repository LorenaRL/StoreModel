	...
	<div class="header-bot_inner_wthreeinfo_header_mid">
		...
		<!-- header-bot -->
			<div class="col-md-4 logo_agile">
				<h1><a href=""><span>S</span>tore<span>M</span>odel <i class="fa fa-shopping-bag top_logo_agile_bag" aria-hidden="true"></i></a></h1>
			</div>
        <!-- header-bot -->
		<div class="col-md-4 agileits-social top_content">
						<ul class="social-nav model-3d-0 footer-social w3_agile_social">
						                                   <li class="share">Compartilhe no : </li>
	...
	<div class="container">
		...
		<div class="top_nav_right">
			<div class="wthreecartaits wthreecartaits2 cart cart box_1"> 
						<form action="#" method="post" class="Últimoltimo"> 
...
<div class="page-head_agile_info_w3l">
		<div class="container">
			<h3>Roupas <span>Masculinas  </span></h3>
			<!--/w3_short-->
		...
		<div class="col-md-4 products-left">
			...
			<div class="css-treeview">
				...
				<ul class="tree-list-pad">
					<li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Roupas Masculinas</label>
						<ul>
							<li><input type="checkbox" id="item-0-0" /><label for="item-0-0"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Roupa de Gala</label>
								<ul>
									<li><a href="mensUsuario.php">Camisas</a></li>
									<li><a href="mensUsuario.php">Bonés</a></li>
									<li><a href="mensUsuario.php">Sapatos</a></li>
									<li><a href="mensUsuario.php">Calças</a></li>
									<li><a href="mensUsuario.php">Óculos escuros</a></li>
									<li><a href="mensUsuario.php">Calças compridas</a></li>
								</ul>
							</li>
					...
					<li><input type="checkbox" checked="checked" id="item-2" /><label for="item-2"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Melhores Ofertas</label>
						<ul>
							<li><input type="checkbox"  id="item-2-0" /><label for="item-2-0"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Desconto de Verão</label>
								<ul>
									<li><a href="mensUsuario.php">Camisas</a></li>
                                                                    <li><a href="mensUsuario.php">Sapatos</a></li>
                                                                    <li><a href="mensUsuario.php">Calças</a></li>
			...
			<div class="community-poll">
				...
				<div class="swit form">	
					...
					<div class="check_box"> <div class="radio"> <label><input type="radio" name="radio"><i></i>Preço Baixo</label> </div></div>
		...
		<div class="col-md-8 products-right">
			...
			<div class="men-wear-bottom">
				...
				<div class="col-sm-8 men-wear-right">
					<h4>COLEÇÕES <span>EXCLUSIVAS MASCULINAS </span></h4>
					<p> A StoreModel possui look específico para o público masculino.  </p>
				</div>
				<div class="clearfix"></div>
			</div>
				<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Blazer Masculino</a></h4>
										<div class="info-product-price">
											<span class="item_price">R$260,99</span>
											<del>R$390,71</del>
										</div>
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="item_name" value="Blazer Masculino">
			...
			<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Tênis de corrida</a></h4>
										<div class="info-product-price">
										...
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="add" value="1">
																	<input type="hidden" name="business" value=" ">
																	<input type="hidden" name="item_name" value="Tênis de corrida">
																	<input type="hidden" name="amount" value="30.99">
																	<input type="hidden" name="discount_amount" value="1.00">
																	<input type="hidden" name="currency_code" value="BR">
																	<input type="hidden" name="return" value=" ">
			...
			<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										...
										<div class="info-product-price">
											<span class="item_price">R$45.99</span>
											<del>R$69.71</del>
										</div>
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="add" value="1" />
																	<input type="hidden" name="business" value=" " />
																	<input type="hidden" name="item_name" value="Camisa azul formal" />
																	<input type="hidden" name="amount" value="30.99" />
																	<input type="hidden" name="discount_amount" value="1.00" />
																	<input type="hidden" name="currency_code" value="BR" />
																	<input type="hidden" name="return" value=" " />
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Suéter</a></h4>
										<div class="info-product-price">
											<span class="item_price">R$45.99</span>
											<del>R$69.71</del>
										</div>
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="add" value="1" />
																	<input type="hidden" name="business" value=" " />
																	<input type="hidden" name="item_name" value="Suéter />
																	<input type="hidden" name="amount" value="30.99" />
																	<input type="hidden" name="discount_amount" value="1.00" />
																	<input type="hidden" name="currency_code" value="BR" />
																	<input type="hidden" name="return" value=" " />
                            ...
                            <div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Calça Azul Escuro</a></h4>
										<div class="info-product-price">
											<span class="item_price">R$80.99</span>
											<del>R$89.71</del>
										</div>
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="add" value="1" />
																	<input type="hidden" name="business" value=" " />
																	<input type="hidden" name="item_name" value="Calça Pista Azul Escuro" />
																	<input type="hidden" name="amount" value="30.99" />
																	<input type="hidden" name="discount_amount" value="1.00" />
																	<input type="hidden" name="currency_code" value="BR" />
																	<input type="hidden" name="return" value=" " />
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Cachecol</a></h4>
										<div class="info-product-price">
											<span class="item_price">$R190.99</span>
											<del>R$159.71</del>
										</div>
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="add" value="1" />
																	<input type="hidden" name="business" value=" " />
																	<input type="hidden" name="item_name" value="Cachecol" />
																	<input type="hidden" name="amount" value="30.99" />
																	<input type="hidden" name="discount_amount" value="1.00" />
																	<input type="hidden" name="currency_code" value="BR" />
																	<input type="hidden" name="return" value=" " />
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Jeans Pretos Masculinos</a></h4>
										<div class="info-product-price">
											<span class="item_price">R$60.99</span>
											<del>R$90.71</del>
										</div>
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="add" value="1" />
																	<input type="hidden" name="business" value=" " />
																	<input type="hidden" name="item_name" value="Jeans Pretos Masculinos" />
																	<input type="hidden" name="amount" value="30.99" />
																	<input type="hidden" name="discount_amount" value="1.00" />
																	<input type="hidden" name="currency_code" value="BR" />
																	<input type="hidden" name="return" value=" " />
								...
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Cinto Reversível</a></h4>
										<div class="info-product-price">
											<span class="item_price">R$30.99</span>
											<del>R$50.71</del>
										</div>
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="add" value="1" />
																	<input type="hidden" name="business" value=" " />
																	<input type="hidden" name="item_name" value="Cinto Reversível" />
																	<input type="hidden" name="amount" value="30.99" />
																	<input type="hidden" name="discount_amount" value="1.00" />
																	<input type="hidden" name="currency_code" value="BR" />
																	<input type="hidden" name="return" value=" " />
...
<div class="footer">
	<div class="footer_agile_inner_info_w3l">
		<div class="col-md-3 footer-left">
			<h2><a href="indexUsuario"><span>S</span>tore<span>M</span>odel </a></h2>
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
							<div class="login-grids">
								...
								<p>Para fazer o login você concorda com nossos <a href="#">Termos e Condições</a> and <a href="#">Privacy Policy</a></p>
							</div>
						</div>
					</div>
				</div>
