		...
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form class="login100-form validate-form">
				<span class="login100-form-title p-b-37">
					Pedimos desculpas, mas NÃO foi possível registrar o seu contato  com sucesso!!!
				</span>
                          				
                            </br>                                <p style="text-align: center;">Tente mais tarde ou nos envie um e-mail.</p>

				</br>
                               	<div class="container-login100-form-btn">
                                    <a href="../contactUsuario.php"<button class="login100-form-btn" style="text-align: center">
