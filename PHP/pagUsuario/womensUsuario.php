...
<html>
<head>
<title>StoreModel Oficial | E-commerce</title>
<!--/tags -->
	...
	<div class="header-bot_inner_wthreeinfo_header_mid">
		...
		<!-- header-bot -->
			<div class="col-md-4 logo_agile">
                            <h1><a href="indexUsuario.php"><span>S</span>tore <span>M</span>odel <i class="fa fa-shopping-bag top_logo_agile_bag" aria-hidden="true"></i></a></h1>
			</div>
        <!-- header-bot -->
		<div class="col-md-4 agileits-social top_content">
						<ul class="social-nav model-3d-0 footer-social w3_agile_social">
						                                   <li class="share">Compartilhar no: </li>
	...
	<div class="container">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class="dropdown menu__item menu__item--current">
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Mulheres <span class="caret"></span></a>
							<ul class="dropdown-menu multi-column columns-3">
								<div class="agile_inner_drop_nav_info">
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
		...
		<div class="top_nav_right">
			<div class="wthreecartaits wthreecartaits2 cart cart box_1"> 
						<form action="#" method="post" class="ultimo"> 
						<input type="hidden" name="cmd" value="carrinho">
						<input type="hidden" name="display" value="1">
						<button class="w3view-cart" type="submit" name="enviar" value=""><i class="fa fa-cart-arrow-down" aria-hidden="true"></i></button>
					</form>  
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h3 class="agileinfo_sign">Logar <span>Agora</span></h3>
									<form action="#" method="post">
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<div class="modal-body modal-body-sub_agile">
						<div class="col-md-8 modal_body_left modal_body_left1">
						<h3 class="agileinfo_sign">Cadastra-se<span>Agora</span></h3>
									<form action="#" method="post">
							<div class="styled-input agile-styled-input-top">
						  ...
						  <ul class="social-nav model-3d-0 footer-social w3_agile_social top_agile_third">
														...
														<div class="clearfix"></div>
														<p><a href="#">Para se registrar você concorda com os nossos temos.</a></p>
...
<div class="page-head_agile_info_w3l">
		<div class="container">
			<h3>Roupas <span>Femininas  </span></h3>
			<!--/w3_short-->
	...
	<div class="container">
		...
		<div class="col-md-4 products-left">
			<div class="filter-price">
				<h3>Filtrar por <span>Preço</span></h3>
			...
			<div class="css-treeview">
				...
				<ul class="tree-list-pad">
					<li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Roupas Femininas</label>
						<ul>
							<li><input type="checkbox" id="item-0-0" /><label for="item-0-0"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Roupas Modernas</label>
								<ul>
                                                                    <li><a href="womensUsuario.php">Camisas</a></li>
									<li><a href="womensUsuario.php">Bonés</a></li>
                                                                        <li><a href="womensUsuario.php">Sapatos</a></li>
                                                                        <li><a href="womensUsuario.php">Calças</a></li>
                                                                        <li><a href="womensUsuario.php">Óculos escuros</a></li>
                                                                        <li><a href="womensUsuario.php">Calças compridas</a></li>
								</ul>
							</li>
							<li><input type="checkbox"  id="item-0-1" /><label for="item-0-1"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Roupa de Festa</label>
								<ul>
                                                                    <li><a href="womensUsuario.php">Vestidos</a></li>
                                                                    <li><a href="womensUsuario.php">Chapéis</a></li>
                                                                    <li><a href="womensUsuario.php">Sapatos</a></li>
                                                                    <li><a href="womensUsuario.php">Acessórios</a></li>
                                                                    <li><a href="womensUsuario.php">Óculos escuros</a></li>
									
								</ul>
							</li>
							<li><input type="checkbox"  id="item-0-2" /><label for="item-0-2"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Roupa Casual</label>
								<ul>
					...
					<li><input type="checkbox" id="item-1" checked="checked" /><label for="item-1"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Melhores Coleções</label>
						<ul>
							<li><input type="checkbox" checked="checked" id="item-1-0" /><label for="item-1-0"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Novos produtos</label>
								<ul>
					...
					<li><input type="checkbox" checked="checked" id="item-2" /><label for="item-2"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Melhores Ofertas</label>
						<ul>
							<li><input type="checkbox"  id="item-2-0" /><label for="item-2-0"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Descontos de Verão</label>
								<ul>
                                                                    <li><a href="womensUsuario.php">Camisas</a></li>
                                                                        <li><a href="womensUsuario.php">Roupa de banho</a></li>
                                                                        <li><a href="womensUsuario.php">Calças</a></li>
									<li><a href="womensUsuario.php">Óculos escuros</a></li>
								</ul>
							</li>
							<li><input type="checkbox" id="item-2-1" /><label for="item-2-1"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Ofertas Emocionantes</label>
								<ul>
									   <li><a href="womensUsuario.php">Camisas</a></li>
									<li><a href="womensUsuario.php">Bonés</a></li>
                                                                        <li><a href="womensUsuario.php">Sapatos</a></li>
							...
							<li><input type="checkbox" id="item-2-2" /><label for="item-2-2"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Descontos Fixos</label>
								<ul>
								   <li><a href="womensUsuario.php">Camisas</a></li>
									<li><a href="womensUsuario.php">Bonés</a></li>
                                                                        <li><a href="womensUsuario.php">Sapatos</a></li>
			...
			<div class="community-poll">
				...
				<div class="swit form">	
					...
					<div class="check_box"> <div class="radio"> <label><input type="radio" name="radio"><i></i>Maior escolha</label> </div></div>
					<div class="check_box"> <div class="radio"> <label><input type="radio" name="radio"><i></i>Mais cores para escolher</label> </div></div>	
					<div class="check_box"> <div class="radio"> <label><input type="radio" name="radio"><i></i>Pagamento Garantido</label> </div></div>
					<div class="check_box"> <div class="radio"> <label><input type="radio" name="radio"><i></i>Dinheiro de volta garantido</label> </div></div>	
		...
		<div class="col-md-8 products-right">
			<h5>Comparar <span>Produto(0)</span></h5>
			<div class="sort-grid">
				<div class="sorting">
					<h6>Ordenar po</h6>
					<select id="country1" onchange="change_country(this.value)" class="frm-field required sect">
						...
						<option value="null">Preço(High - Low)</option>
						<option value="null">Preço(Low - High)</option>	
			...
			<div class="men-wear-bottom">
				...
				<div class="col-sm-8 men-wear-right">
					<h4>COLEÇÕES <span>EXCLUSIVAS FEMININAS</span></h4>
					<p>A StoreModel possui look específico para o público femininas. </p>
				</div>
				<div class="clearfix"></div>
			</div>
		<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Shorts Básicos Pretos</a></h4>
										<div class="info-product-price">
											<span class="item_price">R$124,42</span>
											<del>R$195,10</del>
										</div>
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="item_name" value="Shorts Básicos Pretos">
			...
			<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Bolsa Suiça </a></h4>
										<div class="info-product-price">
											<span class="item_price">R$299,25</span>
											<del>R$369,92</del>
										</div>
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="add" value="1">
																	<input type="hidden" name="business" value=" ">
																	<input type="hidden" name="item_name" value="Bolsa Suiça">
																	<input type="hidden" name="amount" value="30.99">
																	<input type="hidden" name="discount_amount" value="1.00">
																	<input type="hidden" name="currency_code" value="BR">
																	<input type="hidden" name="return" value=" ">
		...
		<div class="single-pro">
			 <div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Saia preta de uma Linha</a></h4>
										<div class="info-product-price">
											<span class="item_price">R$134,71</span>
											<del>R$195,10</del>
										</div>
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="add" value="1" />
																	<input type="hidden" name="business" value=" " />
																	<input type="hidden" name="item_name" value="Saia preta de uma Linha" />
																	<input type="hidden" name="amount" value="30.99" />
																	<input type="hidden" name="discount_amount" value="1.00" />
																	<input type="hidden" name="currency_code" value="BR" />
																	<input type="hidden" name="return" value=" " />
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Top azul sem mangas</a></h4>
										<div class="info-product-price">
											<span class="item_price">R$144,99</span>
											<del>R$195,10</del>
										</div>
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="add" value="1" />
																	<input type="hidden" name="business" value=" " />
																	<input type="hidden" name="item_name" value="Top azul sólido sem mangas" />
																	<input type="hidden" name="amount" value="30.99" />
																	<input type="hidden" name="discount_amount" value="1.00" />
																	<input type="hidden" name="currency_code" value="BR" />
																	<input type="hidden" name="return" value=" " />
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Calça justa</a></h4>
										<div class="info-product-price">
											<span class="item_price">R$155,28</span>
											<del>R$195,10</del>
										</div>
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="add" value="1" />
																	<input type="hidden" name="business" value=" " />
																	<input type="hidden" name="item_name" value="Calça justa" />
																	<input type="hidden" name="amount" value="30.99" />
																	<input type="hidden" name="discount_amount" value="1.00" />
																	<input type="hidden" name="currency_code" value="BR" />
																	<input type="hidden" name="return" value=" " />
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Calça Pista Rosa</a></h4>
										<div class="info-product-price">
											<span class="item_price">R$227,26</span>
											<del>R$400,77</del>
										</div>
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="add" value="1" />
																	<input type="hidden" name="business" value=" " />
																	<input type="hidden" name="item_name" value="Calça Pista Rosa" />
																	<input type="hidden" name="amount" value="30.99" />
																	<input type="hidden" name="discount_amount" value="1.00" />
																	<input type="hidden" name="currency_code" value="BR" />
																	<input type="hidden" name="return" value=" " />
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Relógio analógico</a></h4>
										<div class="info-product-price">
											<span class="item_price">R$330,10</span>
											<del>R$503,61</del>
										</div>
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="add" value="1" />
																	<input type="hidden" name="business" value=" " />
																	<input type="hidden" name="item_name" value="Relógio analógico" />
																	<input type="hidden" name="amount" value="30.99" />
																	<input type="hidden" name="discount_amount" value="1.00" />
																	<input type="hidden" name="currency_code" value="BR" />
																	<input type="hidden" name="return" value=" " />
						    ...
						    <div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Meias de tornozelo</a></h4>
										<div class="info-product-price">
											<span class="item_price">R$103,86</span>
											<del>R$164,24</del>
										</div>
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="add" value="1" />
																	<input type="hidden" name="business" value=" " />
																	<input type="hidden" name="item_name" value="Meias de tornozelo" />
																	<input type="hidden" name="amount" value="30.99" />
																	<input type="hidden" name="discount_amount" value="1.00" />
																	<input type="hidden" name="currency_code" value="BR" />
																	<input type="hidden" name="return" value=" " />
																	<input type="hidden" name="cancel_return" value=" " />
																	<input type="submit" name="submit" value="Adiconar ao carrinho" class="button" />
																</fieldset>
															</form>
														</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.html">Calças Justas Femininas Reebok</a></h4>
										<div class="info-product-price">
											<span class="item_price">R$134,71</span>
											<del>R$174,53</del>
										</div>
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="add" value="1" />
																	<input type="hidden" name="business" value=" " />
																	<input type="hidden" name="item_name" value="Calças Justas Femininas Reebok" />
																	<input type="hidden" name="amount" value="30.99" />
																	<input type="hidden" name="discount_amount" value="1.00" />
																	<input type="hidden" name="currency_code" value="BR" />
																	<input type="hidden" name="return" value=" " />
			...
			<div class="w3layouts_mail_grid">
				<div class="col-md-3 w3layouts_mail_grid_left">
					...
					<div class="w3layouts_mail_grid_left2">
						<h3>FRETE GRÁTIS</h3>
						<p>Nas compras a partir de R$280.00 , você ganha frete grátis.</p>
					</div>
				</div>
				<div class="col-md-3 w3layouts_mail_grid_left">
					<div class="w3layouts_mail_grid_left1 hvr-radial-out">
					...
					<div class="w3layouts_mail_grid_left2">
						<h3> SUPORTE</h3>
						<p>Temos um sistema 24 horas para atender você, no que precisar!</p>
					</div>
				</div>
				<div class="col-md-3 w3layouts_mail_grid_left">
					<div class="w3layouts_mail_grid_left1 hvr-radial-out">
					...
					<div class="w3layouts_mail_grid_left2">
						<h3>DINHEIRO DE VOLTA GARANTIDO</h3>
						<p>Devolvemos seu dinheiro em até 72 horas em caso de insatisfação, demora ou defeitos com o produto.</p>
					</div>
				</div>
					<div class="col-md-3 w3layouts_mail_grid_left">
					<div class="w3layouts_mail_grid_left1 hvr-radial-out">
					...
					<div class="w3layouts_mail_grid_left2">
						<h3>CUPONS GRÁTIS</h3>
						<p>Basta inserí-los durante a compra e será efetuado o desconto</p>
					</div>
				</div>
				<div class="clearfix"> </div>
			</div>
...
<div class="footer">
	<div class="footer_agile_inner_info_w3l">
		<div class="col-md-3 footer-left">
                    <h2><a href="indexUsuario.php"><span>S</span>tore<span>M</span>odel </a></h2>
			<p>Uma loja que há 35 anos veste com elegância e modernidade a sociedade.</p>
		...
		<div class="col-md-9 footer-right">
			<div class="sign-grds">
				...
				<div class="col-md-5 sign-gd-two">
					<h4>StoreModel <span>Informações</span></h4>
					<div class="w3-address">
						<div class="w3-address-grid">
							...
							<div class="w3-address-right">
								...
								<p>61 34832526 ou 61 995643211</p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="w3-address-grid">
							...
							<div class="w3-address-right">
								...
								<p>E-mail :<a href="mailto:example@email.com"> storemodeloficial@gmail.com</a></p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="w3-address-grid">
							...
							<div class="w3-address-right">
								<h6>Local Loja Sede</h6>
								<p> Shopping Pier 21, Asa Sul, Brasília-DF.
		...
		<div class="clearfix"></div>
			<div class="agile_newsletter_footer">
				...
				<h3>CADASTRE-SE PARA SABER AS NOVIDADES DA StoreModel!</h3>
			</div>
			<div class="col-sm-6 newsright">
				<form action="#" method="post">
					<input type="email" placeholder="Insira aqui o seu e-mail ..." name="email" required="">
					<input type="submit" value="Enviar">
				</form>
			</div>
								...
								<div class="login">
									<div class="login-bottom">
										...
										<form>
											<div class="sign-up">
												<h4>E-mail :</h4>
												<input type="text" value="Escreva aqui" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Type here';}" required="">	
											</div>
											<div class="sign-up">
												<h4>Senha :</h4>
									...
									<div class="login-right">
										...
										<form>
											...
											<div class="single-bottom">
												...
												<label for="brand"><span></span>Lembrar-me.</label>
											</div>
											<div class="sign-in">
												<input type="submit" value="LOGAR" >
											</div>
